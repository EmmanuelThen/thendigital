        ...
        <>
            ...
            <NavigationMenu.Root className="hidden lg:flex relative z-[1] w-screen justify-between items-center py-3 px-10">
                    ...
                    <NavigationMenu.Item>
                        ...
                        <NavigationMenu.Content className="data-[motion=from-start]:animate-enterFromLeft data-[motion=from-end]:animate-enterFromRight data-[motion=to-start]:animate-exitToLeft data-[motion=to-end]:animate-exitToRight absolute top-0 left-0 w-full sm:w-auto bg-white z-[999]">
                            <ul className="one relative m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[500px] sm:grid-cols-[0.75fr_1fr]">
                                ...
                                <ListItem description='Keep your website running smoothly with our reliable maintenance services' href='/about'>
                ...
                <div className='flex justify-between gap-3'>
                    <button className='arrow text-slate11 px-2 py-1 flex items-center'>
                        Log in
                        <span>
                    ...
                    <button className='arrow text-red9 p-1 hover:opacity-60 flex items-center'>
                        Sign up
                        <span>
                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.1584 3.13508C6.35985 2.94621 6.67627 2.95642 6.86514 3.15788L10.6151 7.15788C10.7954 7.3502 10.7954 7.64949 10.6151 7.84182L6.86514 11.8418C6.67627 12.0433 6.35985 12.0535 6.1584 11.8646C5.95694 11.6757 5.94673 11.3593 6.1356 11.1579L9.565 7.49985L6.1356 3.84182C5.94673 3.64036 5.95694 3.32394 6.1584 3.13508Z" fill="currentColor" fillRule="evenodd" clipRule="evenodd"></path></svg>
                        </span>
