...
const DashNavbar = (props: Props) => {
    return (
        <div className='flex'>
            <div className='flex flex-col items-center justify-between border-r-[1px] p-10 w-fit overflow-y-hidden h-screen'>
                ...
                <div id='loginName' className='flex flex-col items-center font-semibold text-sm'>
                ...
                <div id='loginTabs' className='flex flex-col gap-8 '>
