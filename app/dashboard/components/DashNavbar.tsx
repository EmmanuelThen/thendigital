...
const DashNavbar = () => {
    ...
    return (
        <>
            <div className='hidden lg:flex'>
                <div className='hidden md:flex md:flex-col items-center justify-between border-r-[1px] p-10 w-fit overflow-y-hidden h-screen'>
                    ...
                    <div id='loginTabs' className='hidden md:flex flex-col gap-8 '>
                        ...
                        <button value='dashboard' className='p-2 flex items-center gap-2 hover:bg-slate2 hover:rounded-md'>
                        ...
                        <button value='inbox' className='p-2 flex items-center gap-2 hover:bg-slate2 hover:rounded-md '>
            ...
            <div className='sm:block lg:hidden w-[100vw]'>
                {/** Mobile screen nav */}
                <div>
                    <DashMobileNavbar />
                </div>
