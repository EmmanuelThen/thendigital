...
const DashSpeedTestBottom = (props: Props) => {
    return (
        <div className='flex justify-center'>
            <button type='button'>
                <Link className='arrow font-medium rounded-md bg-slate2 hover:bg-slate6 px-2 py-1 hover:opacity-60 flex items-center' href='https://pagespeed.web.dev/' target='_blank'>
...
export default DashSpeedTestBottom