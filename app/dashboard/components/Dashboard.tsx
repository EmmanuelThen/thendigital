            ...
            <div className='flex lg:h-screen'>
                <div className='lg:w-1/5'>
                    <div className='hidden lg:flex lg:flex-col items-center justify-between border-r-[1px] p-1 w-fit  h-screen'>
                        ...
                        <div id='loginTabs' className='hidden lg:flex flex-col h-full gap-8 '>
                        ...
                        <div className='hidden lg:block'>
                            <form action="/auth/signout" method="post">
                                <button type='submit' className='mb-5 hover:cursor-pointer bg-red9 text-white inline-flex h-[35px] items-center justify-center gap-2 rounded-[4px] px-[15px] font-light leading-none focus:outline-none' >
