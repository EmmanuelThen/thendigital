                    ...
                    <div className="">
                        <div className=" lg:ml-1 rounded-lg shadow-blackA9 shadow-[0_8px_15px] {lg:w-[1275px] 2xl:w-[1685px]} {4xl:w-[2209px]}">
                                            ...
                                            <div className='flex items-center lg:gap-5 lg:mb-2' id='threeInboxButtons'>
                                                {inboxMessage.length > 0 ? //Button will only show when there is a message in the trash inbox
                                                    <button onClick={handleDeleteNotificationButtonClick}
                                                        ...
                                                        type='button'
                                                        className='shadow-blackA9 shadow-[0_4px_7px] bg-slate8 hover:bg-slate8/80 text-white inline-flex items-center justify-center rounded gap-1 lg:gap-2 py-1 px-2 text-xs lg:text-base lg:py-0 lg:px-[15px] lg:h-[35px] font-light leading-none focus:outline-none'
                                                    >
                                                        Notifications
                                                ...
                                                <DialogButton
                                                    ...
                                                    buttonText={
                                                        <>
                                                            {inboxMessage.length > 0 ? //Button will only show when there is a message in the trash inbox
                                                                <div className=' hover:cursor-pointer bg-red9 text-white inline-flex items-center justify-center rounded gap-1 lg:gap-2 py-1 px-2 text-xs lg:text-base lg:py-0 lg:px-[15px] lg:h-[35px] font-light leading-none focus:outline-none' >
                                                                    Delete
                                                ...
                                                <DialogButton
                                                    ...
                                                    buttonText={
                                                        <>
                                                            {inboxMessage.length > 0 ? //Button will only show when there is a message in the trash inbox
                                                                <div className=' hover:cursor-pointer bg-blue9 text-white inline-flex items-center justify-center rounded gap-1 lg:gap-2 py-1 px-2 text-xs lg:text-base lg:py-0 lg:px-[15px] lg:h-[35px] font-light leading-none focus:outline-none' >
                                                                    Delete All
                            ...
                            <Tabs.Content value="tab2" className="w-full">
                                <div id='back-ground' className="flex lg:p-2 w-full h-screen lg:h-[75vh]">
                                    <div className="lg:w-[35%] w-full overflow-y-scroll">
                                        {inboxTrash.length > 0 ? (
