...
import MobileBillingHistoryTable from './MobileBillingHistoryTable';

type Props = {}

const MobileAccountSection = (props: Props) => {
            ...
            <Tabs.Root className='mt-5' defaultValue="tab1" orientation="vertical">
                ...
                <Tabs.Content value="tab1">
                    <div className='flex flex-col gap-5 p-5 overflow-y-scroll'>
                        ...
                        {/** Second Card */}
                        <div className='rounded-lg border border-1 shadow-lg p-5 text-xs bg-white '>
                        ...
                        <div className='rounded-lg border border-1 shadow-lg p-5 bg-white'>
                            <div className='flex justify-between mb-10'>
                                <h1 className='text-blue9 font-medium text-xs'>Email Notifications</h1>
                                {/** Toggle all button */}
                                <button onClick={handleToggleAllButton} type='button' className='hover:cursor-pointer bg-blue9 hover:bg-blue9/80 text-white inline-flex items-center justify-center gap-1 rounded-[4px] py-1 px-2 text-xs font-light leading-none focus:outline-none' >
                                    Toggle all
                    ...
                    <div className='flex flex-col gap-5 p-5'>
                        ...
                        <div className='flex justify-between items-center rounded-lg border border-1 shadow-lg bg-white'>
                            <div className='flex'>
                                <div className='p-5'>
                                    <div>
                                        <svg width="80" height="80" viewBox="0 0 425 270" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='flex flex-col justify-center p-5 text-xs'>
                                    ...
                                    <h2 className='text-slate10 font-light'>06/13/25</h2>
                        ...
                        <div className='rounded-lg border border-1 shadow-lg p-5 bg-white'>
                            <div className='flex justify-between mb-10'>
                                <h1 className='text-blue9 font-medium text-xs'>Membership Information</h1>
                                <div className=''>
                                    <DialogButton
                                        onClickfunction=''
                                        disabled=''
                                ...
                                <div className='flex flex-col justify-between'>
                                    <div className='mb-10'>
                                        ...
                                        <div className='flex gap-3'>
                                            <DialogButton
                                                ...
                                                buttonText={
                                                    <>
                                                        <div className='hover:cursor-pointer bg-blue9 text-white inline-flex  items-center justify-center gap-1 rounded-[4px] py-1 px-2 text-[10px] font-medium leading-none focus:outline-none' >
                                                            Explore plans
                                                        </div>
                                                    </>
                                                }
                                    ...
                                    <div>
                                        ...
                                        <DialogButton
                                            ...
                                            buttonText={
                                                <>
                                                    <div className='text-[10px] hover:cursor-pointer bg-red9 text-white inline-flex items-center justify-center gap-1 rounded-[4px] py-1 px-2 font-medium leading-none focus:outline-none' >
                                                        Cancel membership
                                                    </div>
                                                </>
                                            }
                                ...
                                <div className='flex flex-wrap flex-col justify-between '>
                                    <div className='mb-10'>
                                        ...
                                        <DialogButton
                                            ...
                                            buttonText={
                                                <>
                                                    <div className='text-[10px] hover:cursor-pointer bg-slate8 text-white inline-flex items-center justify-center gap-1 rounded-[4px] py-1 px-2 font-medium leading-none focus:outline-none' >
                        ...
                        {/** Card Three Billing */}
                        <div className='rounded-lg border border-1 shadow-lg  bg-white text-xs'>
                            <div className='flex justify-between p-5 bg-slate5'>
                                ...
                                <DialogButton
                                    ...
                                    buttonText={
                                        <>
                                            <div className='hover:cursor-pointer bg-red9 text-white inline-flex items-center justify-center gap-1 rounded-[4px] py-1 px-2 text-[10px] font-light leading-none focus:outline-none' >
                                                Clear all invoices
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4">
