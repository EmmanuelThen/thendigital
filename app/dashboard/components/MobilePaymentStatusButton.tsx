...
const MobilePaymentStatusButton = ({ paymentStatus }: PaymentStatusButtonProps) => {
        ...
        return (
            < DialogButton
                ...
                buttonText={
                    ...
                    <>
                        <button className='hover:cursor-pointer hover:bg-blue9/80 rounded-[4px] bg-blue9 text-white inline-flex items-center justify-center  py-1 px-1 text-xs font-light leading-none focus:outline-none'>
...
export default MobilePaymentStatusButton;