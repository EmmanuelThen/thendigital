        ...
        return (
            < DialogButton
                ...
                buttonText={
                    ...
                    <>
                        <button className='hover:cursor-pointer hover:bg-blue9/80 rounded-[4px] bg-blue9 text-white inline-flex items-center justify-center gap-2 py-2 px-3 font-light leading-none focus:outline-none'>
